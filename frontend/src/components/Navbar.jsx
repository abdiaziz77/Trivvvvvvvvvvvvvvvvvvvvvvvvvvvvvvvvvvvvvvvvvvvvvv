      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden xl:flex items-center space-x-4">
            <Link
              to="/login"
              className="px-6 py-2.5 border-2 border-[#F4B942] text-[#F4B942] rounded-lg font-bold hover:bg-[#F4B942] hover:text-white transition duration-300 shadow-md"
            >
              Login
            </Link>
            <Link
              to="/contact"
              className="bg-gradient-to-r from-[#F4B942] to-red-600 hover:from-[#F4B942] hover:to-red-700 text-white px-8 py-2.5 rounded-lg font-bold transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              Get Quote
            </Link>
          </div>
          ...
          <div className="xl:hidden bg-white border-t border-gray-200 shadow-2xl dropdown-container">
            <div className="px-4 pt-4 pb-6 space-y-2">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <Link
                  to="/login"
                  className="block w-full text-center border-2 border-[#F4B942] text-[#F4B942] px-4 py-3 rounded-lg font-bold hover:bg-[#F4B942] hover:text-white transition duration-300"
                  onClick={closeDropdowns}
                >
                  Login
                </Link>
                <Link
                  to="/contact"
                  className="block w-full text-center bg-gradient-to-r from-[#F4B942] to-red-600 hover:from-[#F4B942] hover:to-red-700 text-white px-4 py-3 rounded-lg font-bold transition duration-300 shadow-lg"
                  onClick={closeDropdowns}
                >
                  Get Free Quote
                </Link>
