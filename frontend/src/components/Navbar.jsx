...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-xl sticky top-0 z-50 border-b-2 border-orange-500">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            ...
            >
              <div className="h-12 w-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center mr-3 shadow-lg group-hover:shadow-xl transition duration-300">
                <span className="text-white font-bold text-xl">T</span>
              </div>
              <div className="text-left">
                <h1 className="text-2xl font-black text-gray-900 tracking-tight">TRIBULD</h1>
                <p className="text-xs font-semibold text-orange-600 tracking-widest uppercase">CONSTRUCTION</p>
              </div>
            </Link>
          </div>
            ...
            <Link
              ...
              className={`px-5 py-3 rounded-lg text-sm font-bold transition-all duration-300 ${
                isActiveRoute('/') 
                  ...
                  : 'text-gray-800 hover:bg-gray-50 hover:text-orange-600 hover:border-b-4 hover:border-orange-400'
              }`}
            >
              Home
            </Link>
            ...
            <div className="relative dropdown-container">
              ...
              {openDropdown === 'about' && (
                <div className="absolute left-0 w-72 mt-2 py-3 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
                  <Link
                    to="/about/company"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                    onClick={closeDropdowns}
                  >
                    <div className="font-bold">Our Company</div>
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">History, mission & values</div>
                  </Link>
                  <Link
                    to="/about/leaders"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Executive management</div>
                  </Link>
                  <Link
                    to="/about/team"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Professional team members</div>
                  </Link>
                  <Link
                    to="/about/join"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Career opportunities</div>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openDropdown === 'services' && (
                <div className="absolute left-0 w-80 mt-2 py-3 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Modernization & upgrades</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Premium quality finishes</div>
                  </Link>
                  <Link
                    to="/services/roofing"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Durable roof systems</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Structural integrity</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">MEP systems</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Roads, schools & public works</div>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openDropdown === 'projects' && (
                <div className="absolute left-0 w-72 mt-2 py-3 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Showcase developments</div>
                  </Link>
                  <Link
                    to="/projects/ongoing"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Current developments</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Our portfolio</div>
                  </Link>
                  <Link
                    to="/projects/success"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Client testimonials</div>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openDropdown === 'equipment' && (
                <div className="absolute left-0 w-80 mt-2 py-3 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Heavy equipment fleet</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Equipment servicing</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Quality construction materials</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Storage & distribution</div>
                  </Link>
                  <Link
                    to="/equipment/safety"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Protective equipment</div>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openDropdown === 'technology' && (
                <div className="absolute left-0 w-72 mt-2 py-3 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Digital solutions</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Green building practices</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Standards & compliance</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Skill enhancement</div>
                  </Link>
                </div>
              )}
            </div>
              ...
              {openDropdown === 'blog' && (
                <div className="absolute left-0 w-72 mt-2 py-3 bg-white rounded-xl shadow-2xl z-50 border border-gray-200">
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Latest updates</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Expert insights</div>
                  </Link>
                  <Link
                    to="/blog/safety"
                    className="block px-6 py-4 text-sm text-gray-800 hover:bg-orange-50 hover:text-orange-700 transition duration-300 border-l-4 border-transparent hover:border-orange-500 group"
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Best practices</div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1 group-hover:text-orange-600">Market trends</div>
                  </Link>
                </div>
              )}
            </div>
          ...
          <div className="hidden xl:flex items-center space-x-4">
            <Link
              to="/login"
              className="px-6 py-2.5 border-2 border-orange-500 text-orange-600 rounded-lg font-bold hover:bg-orange-500 hover:text-white transition duration-300 shadow-md"
            >
              Login
            </Link>
            <Link
              to="/contact"
              className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-8 py-2.5 rounded-lg font-bold transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              Get Quote
            </Link>
          </div>
          ...
          <div className="xl:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-3 rounded-lg text-gray-800 hover:text-orange-600 hover:bg-orange-50 focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-300"
            >
          ...
          <div className="xl:hidden bg-white border-t border-gray-200 shadow-2xl dropdown-container">
            <div className="px-4 pt-4 pb-6 space-y-2">
                  ...
                  <div className="ml-4 mt-2 space-y-2 bg-gray-50 rounded-lg p-3">
                    {[
                      ...
                      <Link
                        key={item.path}
                        to={item.path}
                        className="block px-4 py-3 rounded-lg text-sm text-gray-700 hover:bg-orange-100 hover:text-orange-700 transition duration-300 font-semibold"
                        onClick={closeDropdowns}
                      >
                        {item.name}
                      </Link>
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <Link
                  to="/login"
                  className="block w-full text-center border-2 border-orange-500 text-orange-600 px-4 py-3 rounded-lg font-bold hover:bg-orange-500 hover:text-white transition duration-300"
                  onClick={closeDropdowns}
                >
                  Login
                </Link>
                <Link
                  to="/contact"
                  className="block w-full text-center bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-4 py-3 rounded-lg font-bold transition duration-300 shadow-lg"
                  onClick={closeDropdowns}
                >
                  Get Free Quote
                </Link>
