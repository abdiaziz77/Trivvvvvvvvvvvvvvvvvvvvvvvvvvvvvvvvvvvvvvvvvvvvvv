// src/dashboards/Admindashboard/layout/AdminFooter.jsx
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-right">
            <p className="text-gray-600 text-xs">
              © {new Date().getFullYear()} JengaNow Construction Admin System. All rights reserved.
            </p>
            <div className="flex space-x-3 mt-1 justify-center md:justify-end">
              <Link to="/admin/audit-logs" className="text-gray-500 hover:text-[#F4B942] text-xs transition duration-300">
                Audit Logs
              </Link>
              <Link to="/admin/system-health" className="text-gray-500 hover:text-[#F4B942] text-xs transition duration-300">
                System Health
              </Link>
              <Link to="/admin/support" className="text-gray-500 hover:text-[#F4B942] text-xs transition duration-300">
                Admin Support
              </Link>
            </div>
          </div>
